...
const fetchAllCSS = async (font) => {
    ...
    return Promise.all([
        await exports.fetchCSS(fontFamily, variantsList, user_agents_json_1.default.apiv2.woff2),
        await exports.fetchCSS(fontFamily, variantsList, user_agents_json_1.default.apiv2.woff),
        await exports.fetchCSS(fontFamily, variantsList, user_agents_json_1.default.apiv2.ttf),
    ]);
};
...
const processQueue = async (font) => {
    ...
    if (index_1.APIv2[id] !== undefined &&
        font.lastModified === index_1.APIv2[id].lastModified &&
        !forceFlag) {
