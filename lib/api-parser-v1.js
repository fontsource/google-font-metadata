...
const fetchAllCSS = async (font) => {
    ...
    return Promise.all([
        await exports.fetchCSS(font, user_agents_json_1.default.woff2),
        await exports.fetchCSS(font, user_agents_json_1.default.woff),
        await exports.fetchCSS(font, user_agents_json_1.default.ttf),
    ]);
};
