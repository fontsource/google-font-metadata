    ...
    describe.concurrent("Failed validation", () => {
        ...
        describe("APIv2", () => {
            ...
            it("Catches missing unicode-range", () => {
                ...
                expect(() => validate("v2", unicodeObj)).toThrow("No unicodeRange variants found for Abel");
            });
        });
        ...
        describe("APIVariable", () => {
            ...
            it("Catches empty objects", () => {
                expect(() => validate("variable", {})).toThrow("Empty APIVariable Object");
                // Missing record
            ...
            it("Catches incorrect urls", () => {
                ...
                expect(() => validate("variable", urlObj)).toThrow(
                    "too_small"
                );
